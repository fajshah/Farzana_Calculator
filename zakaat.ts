...
let Zakaatpercentage: number=2.5;
let zakaatTolaThreshold:number=7.5;
...
if(zakaatWeight.zakaatWeight>=zakaatTolaThreshold){
  let zakaatApplicableAmount=
  (zakaatWeight.zakaatWeight*goldvalueInAmountPerTola)*(Zakaatpercentage/100);
